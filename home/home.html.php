...
<div id="wrapper">
    ...
    <main>
        <?php foreach ($content as $contents): ?>
            <a href="tours.html"><img src="<?php echo $contents['image']; ?>" alt="Portland Historical Tours" width="850" height="389"></a>
            <h1><?php echo htmlspecialchars($contents['title'], ENT_QUOTES, 'UTF-8'); ?></h1>
